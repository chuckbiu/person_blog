...
const TableCard: React.FC<TableCardProps> = ({ summary, title, onClick, createBy, updateBy, wznr, updatedAt, loading = true}) => {
    return (
        <>
            {
                    ...
                    <div className={TableCart.sectionLeft} onClick={onClick}>
                        <div className={TableCart.content}>
                            ...
                            <div className={TableCart.footer}>
                                <span className={TableCart.time}><TableIcon style={{ width: '16px', height: '16px', marginRight: '5px' }}></TableIcon> 发布于 {formatDate(updatedAt)}</span>
